...
ui <- miniPage(
  ...
  miniTabstripPanel(
    ...
    miniTabPanel(lang$submit_title,
      icon = icon("image"),
      miniContentPanel(
      ...
      miniButtonBlock(actionButton("submit",
        label = lang$submit_label, icon("paper-plane"),
    ...
    miniTabPanel(lang$bounty_title,
      icon = icon("star outline"),
      miniContentPanel(
        helpText(lang$help_bounty),
        tags$hr(),
        materialSwitch(
          inputId = "show_all_bounties",
    ...
    miniTabPanel(lang$quest_title,
      icon = icon("list alternate outline"),
      miniContentPanel(
        ...
        conditionalPanel(
          ...
          conditionalPanel(
            ...
            miniButtonBlock(actionButton("recompute_group",
              label = "Recompute", icon("cogs"),
              style = "color: #fff; background-color: #337ab7; border-color: #2e6da4"
            ),
            border = "top"
            )
          ...
          conditionalPanel(
            ...
            miniButtonBlock(actionButton("reset_password",
              label = "Reset password", icon("cogs"),
              style = "color: #fff; background-color: #337ab7; border-color: #2e6da4"
            ),
            border = "top"
            )
          ...
          conditionalPanel(
            ...
            miniButtonBlock(actionButton("update_params",
              label = "Update parameters", icon("cogs"),
              style = "color: #fff; background-color: #337ab7; border-color: #2e6da4"
            ),
            border = "top"
            )
          ...
          conditionalPanel(
            ...
            selectInput("append_data",
              label = "Choose action",
              choices = c(
                "Override existing data" = 1,
                "Append data" = 2
              )
            ),
            tags$hr(),
            miniButtonBlock(actionButton("update_table",
              label = "Update table", icon("database"),
              style = "color: #fff; background-color: #337ab7; border-color: #2e6da4"
            ),
            border = "top"
            )
          ...
          conditionalPanel(
            ...
            fluidRow(
              ...
              column(
                4,
                actionButton("button_correct", "Correct",
                  icon = icon("check"),
                  style = "color: #fff; background-color: #65ac54; border-color: #65ac54; "
                ),
                actionButton("button_tocheck", "To keep",
                  icon = icon("thumbs-o-up"),
                  style = "color: #fff; background-color: #65ac54; border-color: #65ac54; "
                ),
                actionButton("button_false", "False",
                  icon = icon("remove"),
                  style = "color: #fff; background-color: #d83429; border-color: #d83429"
                ),
                actionButton("button_flou", "Not visible",
                  icon = icon("eye-slash"),
                  style = "color: #fff; background-color: #e57c21; border-color: #e57c21"
                ),
                actionButton("button_marrant", "WTF???",
                  icon = icon("rocket"),
